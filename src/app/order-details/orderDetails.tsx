          ...
          <div className="w-[65%]">
            ...
            <div className="w-full mt-[50px]">
              ...
              <p className="mt-[15px] text-[14px] font-[400]">
                ...
                adipiscing amet elementum vitae sollicitudin. In suspendisse
                quis condimentum a pulvinar orci suspendisse cras at. Ultricies
                dignissim sem viverra phasellus enim id. Eget quis luctus ut
                tincidunt et sagittis ut ut.
              </p>
            </div>
          </div>
